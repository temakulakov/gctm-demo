    ...
    return (
        <>
            <motion.header
                animate={fullWidth ? {
                    opacity: 1,
                    background: "rgba(157,33,53,0.45)",
                    backdropFilter: "blur(10px)",
                    width: "95%"
                } : {opacity: 1, background: "#9D2135", width: "fit-content"}}
            ...
            <AnimatePresence>
                {fullWidth && (
                    ...
                    >
                        {
                            navElemenet.map((item, index) => (
                                <motion.a href={item?.link} key={index}>{item.title}</motion.a>
                            ))
                        }
                    </motion.nav>
                )}
