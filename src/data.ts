    ...
    },
    {
        ...
        subTitle: [
            ...
            },
            {
                ...
                subTitle: [
                    {
                        title: "Постоянная выставка #1",
                        description: "Страница с постоянными экспозициями (как у Третьяковки)"
                    },
                    {
                        title: "Постоянная выставка #2",
                        description: "Страница с постоянными экспозициями (как у Третьяковки)"
                    },
                    {
                        title: "Постоянная выставка #3",
                        description: "Страница с постоянными экспозициями (как у Третьяковки)"
                    },
                ]
            },
            {
                ...
                imageUrl: "https://www.gctm.ru/wp-content/uploads/2019/01/IMG_6827-e1547123113206.jpg",
                subTitle: [
                    {
                        title: "Событие #1",
                        description: "Страница с постоянными экспозициями (как у Третьяковки)",
                        imageUrl: "https://www.gctm.ru/wp-content/uploads/2019/02/KP-238272-1546.jpg"
                    },
                    {
                        title: "Событие  #2",
                        description: "Страница с постоянными экспозициями (как у Третьяковки)",
                        imageUrl: "https://www.gctm.ru/wp-content/uploads/2019/02/Zelenyiy-chelovechek-e1549022103784.png"

                    },
                    {
                        title: "Событие #3",
                        description: "Страница с постоянными экспозициями (как у Третьяковки)",
                        imageUrl: "https://www.gctm.ru/wp-content/uploads/2019/02/museum_history_3-e1550734753217.jpg"
                    },
                ]
            },
            {
